    ...
    return(
        <div className="projects-page">
            ...
            <div className="project1">
                ...
                <img src="https://user-images.githubusercontent.com/73762993/169400301-b66b9efc-a5a5-454e-94c1-7191523b0e56.png" width="600px"/>
                <p>A project I built with React where I populated the app with an API that hosted ~2000 quotes. The app has four distinct routes, the home page, about page, authors page and quotes page.
            ...
            <div className="project2">
                ...
                <img src="https://i.pinimg.com/736x/ac/0b/71/ac0b718d995deda3e1e4ee893501324d.jpg" alt="Kotlin Logo" width="150px" />
                <p>During my last semester at UH, I took a course called Programming Languages and Paradigms. The purpose of the course was to work with multiple programming languages
                ...
                <p>We had two weeks to complete this project and so I divided our time into three series of four day periods with a remaining two days. 
